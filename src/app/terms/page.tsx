    ...
    <MarketingShell active="">
      <div style={{ padding: "72px 44px 96px", maxWidth: 760, margin: "0 auto" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 28, font: "400 15px/1.65 'Hanken Grotesk'", color: "#2a2a30" }}>
          <section>
            <h2 style={{ margin: "0 0 10px", font: "800 20px 'Archivo'" }}>1. The marketplace</h2>
            <p style={{ margin: 0 }}>
          ...
          <section>
            <h2 style={{ margin: "0 0 10px", font: "800 20px 'Archivo'" }}>2. Accounts</h2>
            <p style={{ margin: 0 }}>
          ...
          <section>
            <h2 style={{ margin: "0 0 10px", font: "800 20px 'Archivo'" }}>3. Bookings &amp; payments</h2>
            <p style={{ margin: 0 }}>
          ...
          <section>
            <h2 style={{ margin: "0 0 10px", font: "800 20px 'Archivo'" }}>4. Cancellations &amp; disputes</h2>
            <p style={{ margin: 0 }}>
          ...
          <section>
            <h2 style={{ margin: "0 0 10px", font: "800 20px 'Archivo'" }}>5. Driver obligations</h2>
            <p style={{ margin: 0 }}>
          ...
          <section>
            <h2 style={{ margin: "0 0 10px", font: "800 20px 'Archivo'" }}>6. Liability</h2>
            <p style={{ margin: 0 }}>
          ...
          <section>
            <h2 style={{ margin: "0 0 10px", font: "800 20px 'Archivo'" }}>7. Contact</h2>
            <p style={{ margin: 0 }}>
