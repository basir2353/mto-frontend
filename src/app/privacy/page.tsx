    ...
    <MarketingShell active="">
      <div style={{ padding: "72px 44px 96px", maxWidth: 760, margin: "0 auto" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 28, font: "400 15px/1.65 var(--font-hanken)", color: "#2a2a30" }}>
          <section>
            <h2 style={{ margin: "0 0 10px", font: "800 20px var(--font-archivo)" }}>1. What we collect</h2>
            <p style={{ margin: 0 }}>
          ...
          <section>
            <h2 style={{ margin: "0 0 10px", font: "800 20px var(--font-archivo)" }}>2. How we use it</h2>
            <p style={{ margin: 0 }}>
          ...
          <section>
            <h2 style={{ margin: "0 0 10px", font: "800 20px var(--font-archivo)" }}>3. Sharing</h2>
            <p style={{ margin: 0 }}>
          ...
          <section>
            <h2 style={{ margin: "0 0 10px", font: "800 20px var(--font-archivo)" }}>4. Retention &amp; security</h2>
            <p style={{ margin: 0 }}>
          ...
          <section>
            <h2 style={{ margin: "0 0 10px", font: "800 20px var(--font-archivo)" }}>5. Your rights</h2>
            <p style={{ margin: 0 }}>
          ...
          <section>
            <h2 style={{ margin: "0 0 10px", font: "800 20px var(--font-archivo)" }}>6. Contact</h2>
            <p style={{ margin: 0 }}>
              Privacy questions:{" "}
