  ...
  return (
    ...
    >
      <div style={{ display: "flex", justifyContent: "space-between", gap: 12, alignItems: "baseline" }}>
        <div style={{ font: "800 15px var(--font-archivo)", color: tone.color }}>
          {open ? "Dispute under review" : "Dispute resolved"}
        </div>
        <span style={{ font: "700 11px var(--font-hanken)", textTransform: "uppercase", color: tone.color }}>
          {latest.status}
        </span>
      </div>
      <div style={{ font: "600 13px var(--font-hanken)", color: "#3a3a40", marginTop: 8 }}>
      ...
      <div style={{ font: "500 12px var(--font-hanken)", color: "#8A8A90", marginTop: 10 }}>
